...
TASK1_CONFIG = {
    "name": "Navigate & Reach",
    "num_drones": 1,
    "num_obstacles_range": [2, 3, 4, 5],
    "num_targets": 1,
    "num_targets_range": [1],           # added for consistency
    "time_limit": 120.0,
    "battery_start": 100.0,
    "battery_start_range": [100],       # added for consistency
    "mission_brief": "Fly to the green marker. Avoid all obstacles. Return home when done.",
    "spawn_positions": [[0.0, 0.0, 1.0], [0.5, 0.5, 1.0]]
}
...
TASK2_CONFIG = {
    ...
    "num_targets": 1,
    "num_targets_range": [1],
    "battery_start_range": [70, 75, 80, 85, 90, 95, 100],
    "time_limit": 150.0,
